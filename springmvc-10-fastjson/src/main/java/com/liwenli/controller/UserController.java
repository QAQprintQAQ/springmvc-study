...
/*
    fastjson比jackson好用一点,但是听说fastjsonbug比较多
 */
...
public class UserController {
    ...
    public String jsontest3(Model model) throws JsonProcessingException {
        ...
        userList.add(user3);
        userList.add(user4);
        String str = JSON.toJSONString(userList);//fastjson提供的方法
        return str;//前台接受不需要跳转页面
    ...
    public String jsontest4(Model model) throws JsonProcessingException {
        ...
        String str = JSON.toJSONString(date);//fastjson提供的方法
        return str;//前台接受不需要跳转页面
    ...
    public String jsontest5(Model model){
        ...
        String str = JSON.toJSONString(simpleDate);//fastjson提供的方法
        return str;//前台接受不需要跳转页面
    ...
    public String jsontest6(Model model) throws JsonProcessingException {
        ...
        Date date = new Date();//默认timestamp
